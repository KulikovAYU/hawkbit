...
int main() {
    ...
    auto gatewayToken = "1ef6137927dba99f934d554cc671c4b0";
    auto hawkbitEndpoint = "http://cls-lxc-12:8080";
    auto controllerId = "MA_TEST";

    auto builder = DefaultClientBuilder::newInstance();
    builder->setControllerId(controllerId)->setHawkbitEndpoint(hawkbitEndpoint)
            ->setGatewayToken(gatewayToken)->notVerifyServerCertificate()
