...
namespace ForteConfigurationLoader.CmdExecutionLayer
{
    ...
    public class LinuxCmdSet : ICmdSet
    {
        private readonly IFilesDataStore _filesDataStore;
        private readonly IOptions<DiacUpdaterSettings> _options;
        public LinuxCmdSet(IFilesDataStore filesDataStore, IOptions<DiacUpdaterSettings> options)
        {
        ...
        public bool Execute()
        {
            return new DeploymentCommandBase(_options)
                .AttachIf(new DeployForteExecutableLinuxCommandSet(_filesDataStore, _options),
